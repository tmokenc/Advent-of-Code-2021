...
fn seven_segment_search(input: &str) -> u64 {
    let mut count = 0;
...
fn seven_segment_search_part_2(input: &str) -> u64 {
    let mut total = 0;
...
fn main() -> std::io::Result<()> {
    ...
    println!("Day8 Part 1 Example: {}", seven_segment_search(&example_input));
    println!("Day8 Part 1: {}", seven_segment_search(&input));
    
    println!("Day8 Part 2 Example: {}", seven_segment_search_part_2(&example_input));
    println!("Day8 Part 2: {}", seven_segment_search_part_2(&input));
